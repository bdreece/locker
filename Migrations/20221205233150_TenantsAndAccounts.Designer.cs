...
namespace Locker.Migrations
{
    ...
    [Migration("20221205233150_TenantsAndAccounts")]
    partial class TenantsAndAccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Locker.Models.Entities.Service", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Locker.Models.Entities.Tenant", b =>
                {
                    b.HasOne("Locker.Models.Entities.Role", "AdminRole")
                        .WithMany()
                        .HasForeignKey("AdminRoleID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Locker.Models.Entities.Role", "UserRole")
                        .WithMany()
